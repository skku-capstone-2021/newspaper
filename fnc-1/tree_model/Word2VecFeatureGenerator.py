...
class Word2VecFeatureGenerator(FeatureGenerator):
    ...
    def process(self, df):
        ...
        model = gensim.models.KeyedVectors.load_word2vec_format('./fnc-1/tree_model/GoogleNews-vectors-negative300.bin', binary=True)
        print 'model loaded'
        ...
        outfilename_hvec_train = "./fnc-1/train.headline.word2vec.pkl"
        ...
        if n_test > 0:
            ...
            outfilename_hvec_test = "./fnc-1/test.headline.word2vec.pkl"
        ...
        outfilename_bvec_train = "./fnc-1/train.body.word2vec.pkl"
        ...
        if n_test > 0:
            ...
            outfilename_bvec_test = "./fnc-1/test.body.word2vec.pkl"
        ...
        outfilename_simvec_train = "./fnc-1/train.sim.word2vec.pkl"
        ...
        if n_test > 0:
            ...
            outfilename_simvec_test = "./fnc-1/test.sim.word2vec.pkl"
    ...
    def read(self, header='train'):
        ...
        filename_hvec = "./fnc-1/%s.headline.word2vec.pkl" % header
        with open(filename_hvec, "rb") as infile:
            headlineVec = cPickle.load(infile)

        filename_bvec = "./fnc-1/%s.body.word2vec.pkl" % header
        with open(filename_bvec, "rb") as infile:
            bodyVec = cPickle.load(infile)

        filename_simvec = "./fnc-1/%s.sim.word2vec.pkl" % header
