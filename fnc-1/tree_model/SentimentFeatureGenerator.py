...
class SentimentFeatureGenerator(FeatureGenerator):
    ...
    def process(self, df):
        ...
        outfilename_hsenti_train = "./fnc-1/train.headline.senti.pkl"
        ...
        if n_test > 0:
            ...
            outfilename_hsenti_test = "./fnc-1/test.headline.senti.pkl"
        ...
        outfilename_bsenti_train = "./fnc-1/train.body.senti.pkl"
        ...
        if n_test > 0:
            ...
            outfilename_bsenti_test = "./fnc-1/test.body.senti.pkl"
    ...
    def read(self, header='train'):
        ...
        filename_hsenti = "./fnc-1/%s.headline.senti.pkl" % header
        with open(filename_hsenti, "rb") as infile:
            headlineSenti = cPickle.load(infile)

        filename_bsenti = "./fnc-1/%s.body.senti.pkl" % header
