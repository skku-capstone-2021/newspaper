...
def build_data():
    ...
    body = pd.read_csv("./fnc-1/tree_model/train_bodies_processed.csv")
    stances = pd.read_csv("./fnc-1/tree_model/train_stances_processed.csv")
    ...
    generators = [
                  ...
                  TfidfFeatureGenerator2.TfidfFeatureGenerator(),
                  SvdFeatureGenerator(),
...
def build_test_data():
    ...
    body = pd.read_csv("./fnc-1/tree_model/test_bodies_processed.csv")
    stances = pd.read_csv("./fnc-1/tree_model/test_stances_unlabeled.csv") # needs to contain pair id
    data = pd.merge(stances, body, how='left', on='Body ID')
...
def train():
    ...
    stances = pd.read_csv("./fnc-1/tree_model/test_stances_unlabeled.csv") # same row order as predicted
    
    df_output = pd.read_csv("news.csv", encoding='utf-8')
