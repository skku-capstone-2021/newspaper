...
class TfidfFeatureGenerator(FeatureGenerator):
    ...
    def process(self, df):
        ...
        outfilename_htfidf_train = "./fnc-1/train.headline.tfidf.pkl"
        ...
        if n_test > 0:
            ...
            outfilename_htfidf_test = "./fnc-1/test.headline.tfidf.pkl"
        ...
        outfilename_btfidf_train = "./fnc-1/train.body.tfidf.pkl"
        ...
        if n_test > 0:
            ...
            outfilename_btfidf_test = "./fnc-1/test.body.tfidf.pkl"
        ...
        outfilename_simtfidf_train = "./fnc-1/train.sim.tfidf.pkl"
        ...
        if n_test > 0:
            ...
            outfilename_simtfidf_test = "./fnc-1/test.sim.tfidf.pkl"
    ...
    def read(self, header='train'):
        ...
        filename_htfidf = "./fnc-1/%s.headline.tfidf.pkl" % header
        with open(filename_htfidf, "rb") as infile:
            xHeadlineTfidf = cPickle.load(infile)

        filename_btfidf = "./fnc-1/%s.body.tfidf.pkl" % header
        with open(filename_btfidf, "rb") as infile:
            xBodyTfidf = cPickle.load(infile)

        filename_simtfidf = "./fnc-1/%s.sim.tfidf.pkl" % header
