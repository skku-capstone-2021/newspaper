...
class SvdFeatureGenerator(FeatureGenerator):
    ...
    def process(self, df):
        ...
        outfilename_hsvd_train = "./fnc-1/train.headline.svd.pkl"
        ...
        if n_test > 0:
            ...
            outfilename_hsvd_test = "./fnc-1/test.headline.svd.pkl"
        ...
        outfilename_bsvd_train = "./fnc-1/train.body.svd.pkl"
        ...
        if n_test > 0:
            ...
            outfilename_bsvd_test = "./fnc-1/test.body.svd.pkl"
        ...
        outfilename_simsvd_train = "./fnc-1/train.sim.svd.pkl"
        ...
        if n_test > 0:
            ...
            outfilename_simsvd_test = "./fnc-1/test.sim.svd.pkl"
